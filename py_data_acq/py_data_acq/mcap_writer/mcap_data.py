    ...
    # with open(sys.argv[1], "wb") as f, Writer(f) as mcap_writer:
        # for i in range(1, 11):
            ...
            for name in messages: 
                message_classes[name] = google.protobuf.message_factory.GetMessageClass(hytech_pb2.DESCRIPTOR.message_types_by_name.get(name))
