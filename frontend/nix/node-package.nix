...
let
  sources = {
    ...
    "@remix-run/router-1.16.0" = {
      ...
      version = "1.16.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@remix-run/router/-/router-1.16.0.tgz";
    ...
    "@testing-library/dom-9.3.4" = {
      ...
      src = fetchurl {
        ...
        sha512 = "FlS4ZWlp97iiNWig0Muq8p+3rVDjRiYE+YKGbAqXOu9nwJFFOdL00kFpz42M+4huzYi86vAK1sOOfyOG45muIQ==";
      };
    };
    ...
    "@types/eslint-8.56.4" = {
      ...
      version = "8.56.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/eslint/-/eslint-8.56.4.tgz";
        sha512 = "lG1GLUnL5vuRBGb3MgWUWLdGMH2Hps+pERuyQXCfWozuGKdnhf9Pbg4pkcrVUHjKrU7Rl+GCZ/299ObBXZFAxg==";
      };
    };
    ...
    "@types/node-16.18.84" = {
      ...
      version = "16.18.84";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-16.18.84.tgz";
        sha512 = "mtn6ixzrUK5IMf6gyyMVUsm0TIeF3IYpUr3i0HHTuPJVbdZ6kc93poZ+wCkFNtxXoP/tyGrdVPOL6/WqGXjfXw==";
      };
    };
    ...
    "@types/qs-6.9.12" = {
      ...
      version = "6.9.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/qs/-/qs-6.9.12.tgz";
    ...
    "@types/react-18.2.60" = {
      ...
      version = "18.2.60";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/react/-/react-18.2.60.tgz";
    ...
    "core-js-pure-3.36.0" = {
      ...
      version = "3.36.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/core-js-pure/-/core-js-pure-3.36.0.tgz";
        sha512 = "cN28qmhRNgbMZZMc/RFu5w8pK9VJzpb2rJVR/lHuZJKwmXnoWOpXmMkxqBB514igkp1Hu8WGROsiOAzUcKdHOQ==";
      };
    };
    "core-util-is-1.0.3" = {
      name = "core-util-is";
    ...
    "cssdb-7.11.1" = {
      ...
      version = "7.11.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/cssdb/-/cssdb-7.11.1.tgz";
        sha512 = "F0nEoX/Rv8ENTHsjMPGHd9opdjGfXkgRBafSUGnQKPzGZFB7Lm0BbT10x21TMOCrKLbVsJ0NoCDMk6AfKqw8/A==";
      };
    };
    "cssesc-3.0.0" = {
      name = "cssesc";
    ...
    "daisyui-4.8.0" = {
      ...
      version = "4.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/daisyui/-/daisyui-4.8.0.tgz";
        sha512 = "SXy6MVzhqaa1vPZIdo5K/QAyRaQ4dbRHG+oXy7BFqJnZlwOB6bGkQRqqvClBUY2wCyiiyhk4gY5Ngi1m2JRIEA==";
      };
    };
    ...
    "electron-to-chromium-1.4.684" = {
      ...
      version = "1.4.684";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.4.684.tgz";
        sha512 = "MoDE0pUsIzTewI96Vbv84sTkER9Nbp58pa1K7Ub03s6+2HvuJ+jbnxcLJm22mpomJe+5PWtiPXqhbU5ZkyHU5A==";
      };
    };
    "emittery-0.10.2" = {
      name = "emittery";
    ...
    "react-router-6.23.0" = {
      ...
      version = "6.23.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/react-router/-/react-router-6.23.0.tgz";
    ...
    "react-router-dom-6.23.0" = {
      ...
      version = "6.23.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/react-router-dom/-/react-router-dom-6.23.0.tgz";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@remix-run/router-1.16.0"
      ...
      (sources."@testing-library/dom-9.3.4" // {
        dependencies = [
          sources."ansi-styles-4.3.0"
      ...
      sources."@types/qs-6.9.12"
      sources."@types/range-parser-1.2.7"
      sources."@types/react-18.2.60"
      ...
      sources."caniuse-lite-1.0.30001591"
      ...
      sources."ejs-3.1.9"
      sources."electron-to-chromium-1.4.684"
      ...
      sources."react-router-6.23.0"
      sources."react-router-dom-6.23.0"
